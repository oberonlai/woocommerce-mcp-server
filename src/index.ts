  ...
  try {
    ...
    switch (method) {
      ...
      case 'get_product_meta':
        ...
        if (params.metaKey) {
          return productMetaData.filter((meta: { key: string; value: any }) => meta.key === params.metaKey);
        }
      ...
      case 'update_product_meta':
        ...
        const existingMetaIndex = metaData.findIndex((meta: { key: string; value: any }) => meta.key === params.metaKey);
      ...
      case 'delete_product_meta':
        ...
        const updatedMetaData = currentMetaData.filter((meta: { key: string; value: any }) => meta.key !== params.metaKey);
      ...
      case 'get_order_meta':
        ...
        // If a specific key is requested, filter the meta data
        if (params.metaKey) {
          return orderMetaData.filter((meta: { key: string; value: any }) => meta.key === params.metaKey);
        }
      ...
      case 'update_order_meta':
        ...
        // Look for existing meta with the same key
        const existingOrderMetaIndex = orderMeta.findIndex((meta: { key: string; value: any }) => meta.key === params.metaKey);
      ...
      case 'delete_order_meta':
        ...
        // Filter out the meta key to delete
        const updatedOrderMeta = currentOrderMeta.filter((meta: { key: string; value: any }) => meta.key !== params.metaKey);
      ...
      case 'get_customer_meta':
        ...
        // If a specific key is requested, filter the meta data
        if (params.metaKey) {
          return customerMetaData.filter((meta: { key: string; value: any }) => meta.key === params.metaKey);
        }
      ...
      case 'update_customer_meta':
        ...
        // Look for existing meta with the same key
        const existingCustomerMetaIndex = customerMeta.findIndex((meta: { key: string; value: any }) => meta.key === params.metaKey);
      ...
      case 'delete_customer_meta':
        ...
        // Filter out the meta key to delete
        const updatedCustomerMeta = currentCustomerMeta.filter((meta: { key: string; value: any }) => meta.key !== params.metaKey);
